...
<div class="col-md-12 grid-margin">
	<div class="card">
		<div class="card-body">
			<h4 class="card-title">Tambah Inspektorat Penanggung Jawab</h4>
			<form method="post" action="{{route('inspektorat.save')}}" class="needs-validation-pegawai" id="validation-form" enctype="multipart/form-data">
			{{ csrf_field() }}
